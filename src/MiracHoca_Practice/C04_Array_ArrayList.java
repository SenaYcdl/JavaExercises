...
public class C04_Array_ArrayList {
    public static void main(String[] args) {
        ...
        /*
        asList ile oluşturulan ArrayLiST ler Array gibi davrandığı için add
        gibi metodlar execption fırlatıyor, hata alan arkadaşlar bu yüzden hata alıyor
         */
